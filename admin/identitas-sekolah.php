            ...
            <?php
                if(isset($_POST['submit'])){
                    ...
                    if(!in_array($formatfile_logo, $allowedtype_logo)){
                        ...
                        echo '<div class="alert alert-error">Ukuran file logo sekolah tidak boleh lebih dari 1MB.</div>';
                    ...
                    if(!in_array($formatfile_favicon, $allowedtype_favicon)){
                        ...
                        echo '<div class="alert alert-error">Ukuran file favicon sekolah tidak boleh lebih dari 1MB.</div>';
